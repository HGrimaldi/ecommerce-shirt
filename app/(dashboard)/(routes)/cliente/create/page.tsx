    ...
    return (
        <div className="max-w-5xl mx-auto flex md:items-center md:justify-center h-full p-6">
            <div className="bg-[#cfcfcf] dark:bg-[#1f1f1f] p-6">
                <h1 className="text-2xl">Nombra tu Camiseta</h1>
                <p className="text-sm text-slate-600 dark:text-gray-500">
                    ¿Como te gustaría nombrar tu camiseta? No te preocupes, puedes cambiar esto después.
                </p>
                <Form {...form}>
                    <form
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                            ...
                                            placeholder="ej. 'Camiseta marca...'"
                                            {...field}
                                        />
                                    </FormControl>
                                    <FormDescription>
                                        ¿Que tipo de camiseta?
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
